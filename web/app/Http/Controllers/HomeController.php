...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $naUsers = $this->userRepository->top(50, Region::america(), UserRepository::SORT_LADDER_POINTS, 'DESC');
        $euUsers = $this->userRepository->top(50, Region::europe(), UserRepository::SORT_LADDER_POINTS, 'DESC');
