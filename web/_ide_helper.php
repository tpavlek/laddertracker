 ...
 * Generated for Laravel 5.1.8 (LTS) on 2015-07-24.
 *
...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \Depotwarehouse\LadderTracker\Client\Web\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Depotwarehouse\LadderTracker\Client\Web\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Depotwarehouse\LadderTracker\Client\Web\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Depotwarehouse\LadderTracker\Client\Web\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Depotwarehouse\LadderTracker\Client\Web\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Depotwarehouse\LadderTracker\Client\Web\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Depotwarehouse\LadderTracker\Client\Web\Console\Kernel::bootstrap();
        }
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         *
         * @return \Depotwarehouse\LadderTracker\Client\Web\User|null 
         * @static 
         */
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \Depotwarehouse\LadderTracker\Client\Web\User 
         * @static 
         */
